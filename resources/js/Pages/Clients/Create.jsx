                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                                    ...
                                    <div style={{ position: 'relative', width: '100%', height: '120px', borderRadius: '16px', border: '2px dashed #ede9fe', background: '#f8fafc', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', cursor: 'pointer' }}>
                                        {data.logo ? (
                                            <div style={{ position: 'relative', width: '100%', height: '100%' }}>
                                                <img src={URL.createObjectURL(data.logo)} style={{ width: '100%', height: '100%', objectFit: 'contain', padding: '10px' }} />
                                                <button onClick={(e) => { e.preventDefault(); setData('logo', null); }} style={{ position: 'absolute', top: '8px', right: '8px', width: '32px', height: '32px', borderRadius: '50%', background: '#fff', border: '1px solid #f0eeff', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#ef4444' }}>
                                                    <X size={16} />
                                                </button>
                                            </div>
                                        ) : (
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                                    ...
                                    <div style={{ position: 'relative', width: '100%', height: '80px', borderRadius: '16px', border: '2px dashed #ede9fe', background: '#f8fafc', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', cursor: 'pointer' }}>
                                        {data.avatar ? (
                                            <div style={{ position: 'relative', width: '100%', height: '100%' }}>
                                                <img src={URL.createObjectURL(data.avatar)} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                                <button onClick={(e) => { e.preventDefault(); setData('avatar', null); }} style={{ position: 'absolute', top: '8px', right: '8px', width: '24px', height: '24px', borderRadius: '50%', background: '#fff', border: '1px solid #f0eeff', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#ef4444' }}>
                                                    <X size={12} />
                                                </button>
                                            </div>
                                        ) : (
