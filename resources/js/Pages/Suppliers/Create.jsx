...
export default function Create({ auth }) {
    ...
    return (
        <FigmaLayout user={auth.user}>
            <Head title="Integrate Vendor Entity" />
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div className="space-y-1">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <p className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400 leading-none italic">Sourcing Protocol Initiation</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <CardContent className="p-10 space-y-10 relative z-10 text-white">
                                <div className="space-y-4">
                                    <div className="flex items-center justify-between">
                                        <InputLabel value="Strategic Credit Limit" className="text-[10px] font-black uppercase tracking-[0.3em] text-indigo-100/60 pl-2" />
                                ...
                                <div className="bg-white/10 backdrop-blur-md rounded-[2rem] p-8 space-y-6">
                                    <div className="space-y-3">
                                        <InputLabel value="Payment Protocols" className="text-[10px] font-black uppercase tracking-widest text-indigo-200/50" />
                                        <TextInput
                                    ...
                                    <div className="space-y-3">
                                        <InputLabel value="Operational Status" className="text-[10px] font-black uppercase tracking-widest text-indigo-200/50" />
                                        <select
                        ...
                        <div className="space-y-4 pt-4">
                            ...
                            >
                                {processing ? (
                                    ...
                                    <>
                                        <ShieldCheck size={28} />
                                        <span className="uppercase italic tracking-tighter">Register Entity</span>
                                    </>
                                )}
                            </Button>
                            ...
                            <div className="flex items-center gap-3 justify-center py-4 bg-slate-50/50 dark:bg-slate-800/30 rounded-[2rem]">
                                ...
                                <p className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-300 italic">Secure Ledger Integration</p>
                            </div>
                        </div>
                    </div>
                </form>
