...
import {
    ...
    ShieldCheck, Zap, DollarSign, Briefcase, History
} from 'lucide-react';
...
export default function Edit({ auth, supplier }) {
    ...
    return (
        <FigmaLayout user={auth.user}>
            <Head title={`${t('edit')} - ${supplier.company_name}`} />
            ...
            <div style={{ maxWidth: '1000px', margin: '0 auto', paddingBottom: '5rem' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '2rem' }}>
                    ...
                    <div>
                        <h1 style={{ fontSize: '1.75rem', fontWeight: 800, color: '#1e293b', margin: 0 }}>{t('edit_supplier')}</h1>
                        <p style={{ fontSize: '0.875rem', color: '#64748b', margin: '0.25rem 0 0' }}>{t('update_info_for', { name: supplier.company_name })}</p>
                    </div>
                </div>
