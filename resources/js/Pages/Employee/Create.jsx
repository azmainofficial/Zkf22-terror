            ...
            <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                ...
                <div className="bg-white p-10 rounded-[32px] shadow-sm border border-gray-100 relative overflow-hidden">
                    <div className="absolute top-0 right-0 p-12 opacity-[0.03] pointer-events-none">
                        <ArrowUpCircleIcon className="w-64 h-64 text-[#22C55E]" />
                    </div>

                    <div className="relative z-10">
                        <h2 className="text-3xl font-black text-gray-900 tracking-tight">Add New Employee</h2>
                        <p className="text-sm text-gray-500 font-medium mt-1">Fill in the details to register a new member to the system.</p>
                        ...
                        <form onSubmit={submit} className="mt-12 space-y-8">
                            ...
                            <div className="pt-8 border-t border-gray-100 flex justify-end">
                                ...
                                >
                                    {processing ? 'Processing...' : 'Create Employee'}
                                </button>
                            </div>
                        </form>
                    </div>
