...
export default function Create({ shifts, departments }) {
            ...
            <div className="max-w-5xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                ...
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <div className="flex-1 space-y-8">
                        <div className="bg-white p-8 md:p-12 rounded-[48px] shadow-sm border border-gray-100 relative overflow-hidden">
                            <div className="absolute top-0 right-0 p-12 opacity-[0.02] pointer-events-none">
                                <Sparkles className="w-64 h-64 text-[#22C55E]" />
                            </div>

                            <div className="relative z-10">
                                <h1 className="text-3xl font-black text-gray-900 tracking-tight uppercase">Talent Onboarding</h1>
                                <p className="text-sm text-gray-500 font-bold uppercase tracking-widest mt-2 border-l-4 border-[#22C55E] pl-4">Personnel Intelligence Registration</p>
                    ...
                    <div className="w-full lg:w-80 space-y-6">
                        <Card className="rounded-[40px] border-none shadow-sm bg-white p-2">
                            <div className="p-6 text-center">
                                <div className="w-24 h-24 rounded-[32px] bg-gray-50 border-4 border-dashed border-gray-100 flex items-center justify-center text-gray-300 mx-auto group-hover:border-[#22C55E] transition-colors">
                                    <User size={40} />
                                </div>
                                <h3 className="text-xl font-black mt-4 text-gray-900 leading-tight">New Asset</h3>
                                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mt-1">Pending Sync</p>
                            </div>
                        </Card>

                        <Card className="rounded-[40px] border-none shadow-sm bg-[#22C55E] p-8 text-white">
                            <h4 className="text-xs font-black uppercase tracking-widest opacity-60">Insight</h4>
                            <p className="mt-4 font-bold text-sm leading-relaxed italic">
                                "The biometric terminal will automatically sync this profile once registration is finalized. Ensure the Employee ID matches the Physical Terminal input."
                            </p>
                            <div className="mt-6 flex items-center gap-3">
                                <div className="p-2 rounded-xl bg-white/20">
                                    <Calendar size={16} />
                                </div>
                                <span className="text-[10px] font-black uppercase">Audit: {new Date().toLocaleDateString()}</span>
                            </div>
                        </Card>
                    </div>
                </div>
