...
export default function Create({ auth, suppliers, inventory_items, new_po_number }) {
    // Local state for items
    const [lineItems, setLineItems] = useState([
        { inventory_item_id: '', quantity: 1, unit_price: 0, total: 0 }
    ]);
    ...
    return (
        <FigmaLayout user={auth.user}>
            <Head title="Initialize Procurement Node" />
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div className="space-y-1">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <p className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400 leading-none italic">Procurement Identifier: {new_po_number}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-8 space-y-10">
                        <Card className="rounded-[44px] border-none bg-white dark:bg-slate-900 shadow-sm overflow-hidden relative">
                            <div className="absolute top-0 right-0 p-10 opacity-5 pointer-events-none rotate-12">
                                <Truck size={240} className="text-indigo-600" />
                            </div>
                            ...
                            <CardContent className="p-10 md:p-14 space-y-12 relative z-10">
                                ...
                                <div className="space-y-8">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                        ...
                                        <div className="space-y-4">
                                            <InputLabel value="Initial Lifecycle Status" className="text-[10px] font-black uppercase tracking-widest text-slate-500 pl-4" />
                                            <select
                        ...
                        <div className="space-y-4 pt-4">
                            ...
                            >
                                {processing ? (
                                    ...
                                    <>
                                        <ShieldCheck size={28} />
                                        <span className="uppercase italic tracking-tighter">Commit Manifest</span>
                                    </>
                                )}
                            </Button>
                            ...
                            <div className="flex items-center gap-3 justify-center py-4 bg-slate-50/50 dark:bg-slate-800/30 rounded-[2rem]">
                                ...
                                <p className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-300 italic">Initiating Procurement Circuit</p>
                            </div>
                        </div>
                    </div>
                </form>
