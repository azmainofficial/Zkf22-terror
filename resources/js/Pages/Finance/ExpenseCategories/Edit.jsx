...
import { ArrowLeft, Save, Sparkles, Layout, Palette, CheckCircle2, XCircle } from 'lucide-react';
...
export default function Edit({ auth, category }) {
    ...
    return (
        <FigmaLayout user={auth.user}>
            <Head title={tr('Edit Category', 'ক্যাটাগরি সম্পাদনা')} />
            ...
            <div style={{ maxWidth: '800px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                    ...
                    <div>
                        <h1 style={{ fontSize: '1.5rem', fontWeight: 800, color: '#1e1b4b', margin: 0 }}>
                            {tr('Edit Category', 'ক্যাটাগরি সম্পাদনা')}
                        </h1>
                        <p style={{ fontSize: '0.85rem', color: '#6b7280', margin: '4px 0 0', fontWeight: 500 }}>
                            {tr(`Update settings for "${category.name}"`, `"${category.name}" এর সেটিংস আপডেট করুন`)}
                        </p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} style={{ 
                    ...
                    <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '12px', marginTop: '1rem', paddingTop: '1.5rem', borderTop: '1.5px solid #f9fafb' }}>
                        ...
                        >
                            <Save size={18} />
                            {processing ? tr('Updating...', 'আপডেট হচ্ছে...') : tr('Update Category', 'আপডেট করুন')}
                        </button>
                    </div>
                </form>
            </div>
